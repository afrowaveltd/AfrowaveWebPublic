...
public class ManifestControllerTests
{
    ...
    public ManifestControllerTests()
    {
        ...
        urlHelperMock.Setup(x => x.Content(It.IsAny<string>())).Returns<string>(s => s); // Return the input string as-is
    ...
    public async Task GetManifestAsync_ShouldReturnManifestJson_WhenIconsExist()
    {
        ...
        _applicationsManagerMock.Setup(m => m.GetAuthenticatorImagesLinksAsync())
