namespace Id.Tests.Api
{
	...
	public class SmtpToolsTests
	{
		...
		public async Task AutodetectSettings_ShouldReturnDetectedSettings_WhenHostIsValid()
		{
			...
			_ = _mockEmailManager.AutodetectSmtpSettingsAsync(Arg.Any<DetectSmtpSettingsInput>()).Returns(Task.FromResult(expectedResult));
		...
		public async Task TestSettings_ShouldReturnSuccess_WhenSmtpIsValid()
		{
			...
			_ = _mockEmailManager.TestSmtpSettingsAsync(Arg.Any<SmtpSenderModel>()).Returns(Task.FromResult(expectedResult));
